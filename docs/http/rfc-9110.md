...
!!! tip "Watch & learn"
    ...
    - [Official docs for this topic](https://symfony.com/doc/current/components/http_foundation.html) — Symfony's HttpFoundation docs, which implement this specification.
