...
**C'est quoi ?** Une **fiche imprimable, tenant sur une page**, qui résume chaque sous-chapitre de Console en quelques puces "à retenir" suivies d'une ligne "Cheat" très dense.
...
**⚠️ Erreur fréquente :** Imprimer cette fiche *avant* d'avoir étudié Console en détail, en espérant apprendre directement dessus — le format est trop dense pour un premier apprentissage, il ne fonctionne qu'en rappel.
