...
**C'est quoi ?** Cette page est une **banque de 71 questions type QCM** sur Automated Tests, avec correction dépliable sous chaque question. Ce n'est pas un cours : c'est un entraînement, à faire après avoir lu le chapitre.
