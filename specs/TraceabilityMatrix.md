...
| Official Topic | Official Subtopic | Main Chapter | Additional Chapters | Example | Exercise | Solution | Situational Q | Pitfall | Sf 8.0 Ref | Official Ref | Status | Anomaly |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Messenger | Messenger component | `messenger/component.md` | `messenger/index.md` | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | Split (this lot) from a prior monolithic miscellaneous/messenger.md into docs/messenger/ — one chapter per official subtopic, each with its own full anatomy. |
| Messenger | Messages and handlers | `messenger/messages-handlers.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | — |
| Messenger | Middleware | `messenger/middleware.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | — |
| Messenger | Transports | `messenger/transports.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | Third-party transports (Doctrine, Redis, Amazon SQS) are out of scope — see Out-of-scope section; the chapter says so explicitly. |
| Messenger | Workers | `messenger/workers.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | — |
| Messenger | Retries and failures | `messenger/retries-failures.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | — |
| Messenger | Events | `messenger/events.md` | — | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | PASS | Covers 6 worker events (WorkerStarted/MessageReceived/MessageHandled/MessageFailed/Running/Stopped/RateLimited) plus the dispatch-side SendMessageToTransportsEvent, verified against source. |
