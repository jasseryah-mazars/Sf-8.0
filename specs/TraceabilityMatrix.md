...
_Generated by `tools/gen_traceability_matrix.py` on 2026-08-27, branch `master`, commit `911901c` (**working tree had uncommitted changes at generation time**), Python 3.11.15. Re-run the tool to refresh; `tools/check_report_freshness.py` flags this report as stale once the repo's HEAD moves past the commit above._
...
| ID | Domaine | Sous-sujet | Chapitre | Quiz | Structurel | Technique | Éditorial | Statut | Dernière validation | Anomalie |
|---|---|---|---|---|---|---|---|---|---|---|
| HTTP-01 | HTTP | HTTP Specification (RFC 9110) | `http/rfc-9110.md` | 1 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | New chapter this lot; authored from trained knowledge of RFC 9110 (rfc-editor.org unreachable from this environment this session — text not re-fetched live). No French translation yet. |
...
| ID | Domaine | Sous-sujet | Chapitre | Quiz | Structurel | Technique | Éditorial | Statut | Dernière validation | Anomalie |
|---|---|---|---|---|---|---|---|---|---|---|
| ARCH-01 | Symfony Architecture | Symfony Flex | `architecture/flex.md` | 8 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| ARCH-02 | Symfony Architecture | License | `architecture/license.md` | 5 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
...
| ARCH-10 | Symfony Architecture | Official best practices | `architecture/best-practices.md` | 6 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| ARCH-11 | Symfony Architecture | Release management | `architecture/release-management.md` | 8 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
...
| ARCH-15 | Symfony Architecture | Release management & roadmap schedule | `architecture/roadmap-schedule.md` | 6 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
...
| MISC-02 | Miscellaneous | PropertyAccess component | `miscellaneous/property-access.md` | 2 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | New chapter (this lot), verified against PropertyAccessor/PropertyAccessorBuilder/ReflectionExtractor source on the 8.0 branch. No French translation yet. |
...
| ID | Domaine | Sous-sujet | Chapitre | Quiz | Structurel | Technique | Éditorial | Statut | Dernière validation | Anomalie |
|---|---|---|---|---|---|---|---|---|---|---|
| MSG-01 | Messenger | Messenger component | `messenger/component.md` | 3 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | Split (this lot) from a prior monolithic miscellaneous/messenger.md into docs/messenger/ — one chapter per official subtopic, each with its own full anatomy. |
| MSG-02 | Messenger | Messages and handlers | `messenger/messages-handlers.md` | 6 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| MSG-03 | Messenger | Middleware | `messenger/middleware.md` | 5 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| MSG-04 | Messenger | Transports | `messenger/transports.md` | 5 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | Third-party transports (Doctrine, Redis, Amazon SQS) are out of scope — see Out-of-scope section; the chapter says so explicitly. |
| MSG-05 | Messenger | Workers | `messenger/workers.md` | 2 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| MSG-06 | Messenger | Retries and failures | `messenger/retries-failures.md` | 5 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | — |
| MSG-07 | Messenger | Events | `messenger/events.md` | 2 Q | ✓ | ✓ | ✓ | conforme | 2026-08-27 | Covers 6 worker events (WorkerStarted/MessageReceived/MessageHandled/MessageFailed/Running/Stopped/RateLimited) plus the dispatch-side SendMessageToTransportsEvent, verified against source. |
