...
| P1-02 | Code/config fragment testing (PHP 8.4, YAML, XML, Twig) | in progress | PHP: `tools/lint_php.py` reports 382 blocs testés, 0 erreur against PHP 8.4.19 — a real, verified result (parses/lints cleanly; not an independent confirmation of Symfony-8.0-API accuracy). YAML fragments and Twig-fragment syntax checking are being added this run — see RemediationLog. |
